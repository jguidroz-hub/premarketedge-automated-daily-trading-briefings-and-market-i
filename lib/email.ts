...
const FROM = process.env.EMAIL_FROM || 'PreMarketEdge - Automated daily trading briefings and market intelligence platform <noreply@example.com>';
const APP_NAME = 'PreMarketEdge - Automated daily trading briefings and market intelligence platform';
