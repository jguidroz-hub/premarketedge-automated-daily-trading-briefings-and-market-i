  ...
  try {
    ...
    return new NextResponse(JSON.stringify(exportData, null, 2), {
      headers: {
        ...
        'Content-Disposition': `attachment; filename="PreMarketEdge - Automated daily trading briefings and market intelligence platform-export-${new Date().toISOString().split('T')[0]}.json"`,
      },
    });
  } catch (error: any) {
