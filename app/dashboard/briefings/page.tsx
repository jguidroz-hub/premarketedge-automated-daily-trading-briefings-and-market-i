...
export default function BriefingsPage() {
  const [items, setItems] = useState<BriefingsItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Daily Market Intelligence</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Automated pre-market trading insights</p>
